...
ANTSMC6DOF::ANTSMC6DOF(const float& sample_time, const float* alpha, const float* beta_, const float* K2, const float* K_alpha, const float* K_min, const float* K1_init, const float* mu)
