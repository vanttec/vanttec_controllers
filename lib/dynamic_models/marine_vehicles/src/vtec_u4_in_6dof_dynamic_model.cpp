...
VTecU4InDynamicModel::VTecU4InDynamicModel(const float& sample_time) : GenericIn6DOFUUVDynamicModel(sample_time)
{
    /* Physical Parameters */
...
void VTecU4InDynamicModel::updateThrust()
{
    ...
    Thrust_ << (L_.completeOrthogonalDecomposition().pseudoInverse())*tau_;
}